        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <tbody>
              ...
              <tr>
                <th scope="row"><?= $i++ ?></th>
                <td>
                  <img src="img/<?= $new["foto"]; ?>" style="width: 150px; height: 75px;">
                </td>
                <td><?= $new["judul"]; ?></td>
                <td><?= $new["kategori"]; ?></td>
                <td><?= $new["deskripsi"]; ?></td>
                <td>
                  <button><a href="delete.php?id=<?= $new["id"] ?>">Hapus</a></button>
                  <button><a href="ubah.php?id=<?= $new["id"]; ?>">Ubah</a></button>
                </td>
              </tr>
              <?php endforeach ; ?>
              ...
              <tr>
                  ...
                  <td>
                    ...
                    <!-- <select class="form-select" aria-label="Default select example" nama="kategori" id="kategori">
